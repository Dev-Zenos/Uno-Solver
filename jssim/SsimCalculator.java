...
public class SsimCalculator 
{
    ...
    public SsimCalculator(BufferedImage img) throws SsimException, IOException 
    {
        this.refImage = img;
    }
    ...
    public double compareTo(byte[] comp) throws SsimException, IOException 
    {
        final byte[] compBytes = comp;
        final WindowManager manager = getWindowManager(compBytes);
